 ...
 * Config Server defines {@link ConfigServicePropertySourceLocator} class with {@code @Order(0)}.
 * On the other hand, AWS Parameter Store config defines {@link AwsParamStorePropertySourceLocator} which does not
 * specify any {@code @Order}. This means it will have {@code Ordered.LOWEST_PRECEDENCE} by default.
 * <p/>
 * This class extends {@link AwsParamStorePropertySourceLocator} and does nothing but specifies {@code @Order}
 * higher than Config Server does.
 * <p/>
 * NOTE: {@link AwsParamStorePropertySourceLocator} will still be loaded and uselessly retrieve properties from
 * AWS Parameter Store.
 */
@Configuration
@Primary
